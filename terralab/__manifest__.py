# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'data/sites.xml',
        # Reports
        'reports/default/order_confirmation_document.xml',
        'reports/default/order_confirmation.xml',
        'reports/default/test_results.xml',
        'reports/default/test_results_document.xml',
        # Models
        ...
        'views/target_use_views.xml',
        # Menu
        'views/menu_actions.xml',
        'views/menu_items.xml',
        # Web
        'views/web/mass_edit_tests.xml',
    ],
    'css': [
        'static/src/css/terralab.css',
    ],
    ...
    # PIP requirements - install with pip3 install google-api-python-client google-auth google-auth-httplib2 google-auth-oauthlib oauth2client typing-extensions
    'external_dependencies': {
        'python': ['google-api-python-client', 'google-auth', 'google-auth-httplib2', 'google-auth-oauthlib', 'oauth2client', 'typing-extensions'],
    },
}
